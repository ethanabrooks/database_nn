...
python $JOB_PATH/qa_wiki_parser.py $JOB_PATH/question_answer_pairs /scratch-shared/users/bensonc/enwiki-20160204-pages-meta-current.xml $JOB_PATH/output_nn_new $JOB_PATH/question_status
